...
console.log(getBMICategory(17));
console.log(getBMICategory(22));
console.log(getBMICategory(27));
console.log(getBMICategory(35));
...
function getDiscount(age, isMember) {
  if (age < 12) {
    return "Since You are below 12, we are giving you 50% discount";
  } else if (isMember) {
    if (age >= 60) {
      return "Since you are Senior member, we are giving you 30% discount";
    } else {
      return "Since you are Our Regular member, we are giving you 20% discount";
    }
  } else {
    if (age >= 60) {
      return "Since you are Senior but Not Member, we are giving you 10% discount";
    } else {
...
console.log(getDiscount(8, false));
console.log(getDiscount(65, true));
console.log(getDiscount(30, true));
console.log(getDiscount(65, false));
console.log(getDiscount(25, false));
...
console.log(getSeasonMessage(1)); 
console.log(getSeasonMessage(5)); 
console.log(getSeasonMessage(8));
console.log(getSeasonMessage(10)); 
...
students.forEach(details => {
    console.log(`${details.name} scored ${details.score}`)
...
const filteredStudents = students.filter(student => student.city === "Delhi")
...
const findStudent = students.find(student => students.id === 4)
console.log(findStudent)


const index = students.findIndex(student => students.name === "Sneha")
console.log(index)
...
const result1 = students.every(student => student.passed);
console.log(result1)

const above90 = students.some(student => student.score > 90);
console.log(above90);
// --------------------
//  TODO D7 — reduce:
